...
function scopeBadge(scope: string) {
  const colors: Record<string, string> = {
    "ewr:push":    "bg-amber-900/20 text-amber-300 border-amber-800/40",
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4">
          <div>
            ...
            <Input
              id="key-name"
              placeholder="e.g. Nakuru Silo Portal"
              value={name}

...
async function seed() {
  ...
  const ewrValues = [
    // ── Maize (6 receipts) — FUNGIBLE, EAS 2:2013 ─────────────────────────
    {
      ewrsReceiptId: "EWR-NBI-2025-001", wrscSignature: "WRSC-SIG-7f8a9b2c",
      warehouseCode: "NBI-WH-01", commodityType: "MAIZE" as const, batchType: "FUNGIBLE" as const,
      grade: "Grade 1", weightMt: "250.000", harvestSeason: "2025-LR",
      isLienActive: false, state: "INGESTED" as const, ownerId: producer1.id,
      estimatedValueUsd: "50000.00",
      moisturePct: "12.50", foreignMatterPct: "0.45", brokenGrainsPct: "1.20", insectDamagedGrainsPct: "0.30",
      poolGroupId: "NBI-WH-01_MAIZE_Grade 1_12.50",
    },
    {
      ewrsReceiptId: "EWR-NBI-2025-002", wrscSignature: "WRSC-SIG-3c4d5e6f",
      warehouseCode: "NBI-WH-01", commodityType: "MAIZE" as const, batchType: "FUNGIBLE" as const,
      grade: "Grade 2", weightMt: "180.500", harvestSeason: "2025-LR",
      isLienActive: false, state: "MARKET_LISTED" as const, ownerId: producer1.id,
      estimatedValueUsd: "32490.00",
      moisturePct: "13.20", foreignMatterPct: "0.72", brokenGrainsPct: "1.85", insectDamagedGrainsPct: "0.60",
      poolGroupId: "NBI-WH-01_MAIZE_Grade 2_13.20",
    },
    {
      ewrsReceiptId: "EWR-NBI-2025-010", wrscSignature: "WRSC-SIG-8w9x0y1z",
      warehouseCode: "NBI-WH-01", commodityType: "MAIZE" as const, batchType: "FUNGIBLE" as const,
      grade: "Grade 1", weightMt: "320.000", harvestSeason: "2025-LR",
      isLienActive: false, state: "INGESTED" as const, ownerId: producer2.id,
      estimatedValueUsd: "64000.00",
      moisturePct: "12.10", foreignMatterPct: "0.38", brokenGrainsPct: "0.95", insectDamagedGrainsPct: "0.22",
      poolGroupId: "NBI-WH-01_MAIZE_Grade 1_12.10",
    },
    {
      ewrsReceiptId: "EWR-ELD-2025-011", wrscSignature: "WRSC-SIG-2a3b4c5d",
      warehouseCode: "ELD-WH-06", commodityType: "MAIZE" as const, batchType: "FUNGIBLE" as const,
      grade: "Grade 1", weightMt: "500.000", harvestSeason: "2024-SR",
      isLienActive: false, state: "MARKET_LISTED" as const, ownerId: producer2.id,
      estimatedValueUsd: "95000.00",
      moisturePct: "12.80", foreignMatterPct: "0.55", brokenGrainsPct: "1.50", insectDamagedGrainsPct: "0.40",
      poolGroupId: "ELD-WH-06_MAIZE_Grade 1_12.80",
    },
    {
      ewrsReceiptId: "EWR-ELD-2025-015", wrscSignature: "WRSC-SIG-8q9r0s1t",
      warehouseCode: "ELD-WH-06", commodityType: "MAIZE" as const, batchType: "FUNGIBLE" as const,
      grade: "Grade 2", weightMt: "400.000", harvestSeason: "2024-SR",
      isLienActive: false, state: "SETTLED" as const, ownerId: offtaker.id,
      estimatedValueUsd: "68000.00",
      moisturePct: "13.50", foreignMatterPct: "0.88", brokenGrainsPct: "1.95", insectDamagedGrainsPct: "0.90",
      poolGroupId: "ELD-WH-06_MAIZE_Grade 2_13.50",
    },
    {
      ewrsReceiptId: "EWR-KSM-2025-016", wrscSignature: "WRSC-SIG-A1B2C3D4",
      warehouseCode: "KSM-WH-03", commodityType: "MAIZE" as const, batchType: "FUNGIBLE" as const,
      grade: "Grade 1", weightMt: "350.000", harvestSeason: "2025-LR",
      isLienActive: false, state: "MARKET_LISTED" as const, ownerId: producer1.id,
      estimatedValueUsd: "66500.00",
      moisturePct: "12.30", foreignMatterPct: "0.42", brokenGrainsPct: "1.10", insectDamagedGrainsPct: "0.28",
      poolGroupId: "KSM-WH-03_MAIZE_Grade 1_12.30",
    },

    // ── Rice (4 receipts) — FUNGIBLE, EAS 128:2013 ────────────────────────
    {
      ewrsReceiptId: "EWR-MOM-2025-003", wrscSignature: "WRSC-SIG-1a2b3c4d",
      warehouseCode: "MOM-WH-02", commodityType: "RICE" as const, batchType: "FUNGIBLE" as const,
      grade: "Premium", weightMt: "100.000", harvestSeason: "2025-IR1",
      isLienActive: false, state: "MARKET_LISTED" as const, ownerId: producer1.id,
      estimatedValueUsd: "60000.00",
      moisturePct: "11.00", foreignMatterPct: "0.30", brokenGrainsPct: "0.90", insectDamagedGrainsPct: "0.20",
      poolGroupId: "MOM-WH-02_RICE_Premium_11.00",
    },
    {
      ewrsReceiptId: "EWR-MOM-2025-012", wrscSignature: "WRSC-SIG-6e7f8g9h",
      warehouseCode: "MOM-WH-02", commodityType: "RICE" as const, batchType: "FUNGIBLE" as const,
      grade: "Standard", weightMt: "200.000", harvestSeason: "2025-IR1",
      isLienActive: false, state: "INGESTED" as const, ownerId: producer1.id,
      estimatedValueUsd: "100000.00",
      moisturePct: "12.50", foreignMatterPct: "0.65", brokenGrainsPct: "1.60", insectDamagedGrainsPct: "0.55",
      poolGroupId: "MOM-WH-02_RICE_Standard_12.50",
    },
    {
      ewrsReceiptId: "EWR-MOM-2025-017", wrscSignature: "WRSC-SIG-E5F6G7H8",
      warehouseCode: "MOM-WH-02", commodityType: "RICE" as const, batchType: "FUNGIBLE" as const,
      grade: "Premium", weightMt: "75.000", harvestSeason: "2024-IR2",
      isLienActive: false, state: "MARKET_LISTED" as const, ownerId: producer2.id,
      estimatedValueUsd: "45000.00",
      moisturePct: "11.20", foreignMatterPct: "0.35", brokenGrainsPct: "1.05", insectDamagedGrainsPct: "0.25",
      poolGroupId: "MOM-WH-02_RICE_Premium_11.20",
    },
    {
      ewrsReceiptId: "EWR-NBI-2025-018", wrscSignature: "WRSC-SIG-I9J0K1L2",
      warehouseCode: "NBI-WH-01", commodityType: "RICE" as const, batchType: "FUNGIBLE" as const,
      grade: "Standard", weightMt: "150.000", harvestSeason: "2025-IR1",
      isLienActive: false, state: "INGESTED" as const, ownerId: producer2.id,
      estimatedValueUsd: "75000.00",
      moisturePct: "12.00", foreignMatterPct: "0.58", brokenGrainsPct: "1.40", insectDamagedGrainsPct: "0.48",
      poolGroupId: "NBI-WH-01_RICE_Standard_12.00",
    },

    // ── Coffee (4 receipts) — SEMI_FUNGIBLE, micro-lot isolation ──────────
    {
      ewrsReceiptId: "EWR-KSM-2025-004", wrscSignature: "WRSC-SIG-9e0f1a2b",
      warehouseCode: "KSM-WH-03", commodityType: "COFFEE" as const, batchType: "SEMI_FUNGIBLE" as const,
      grade: "AA", weightMt: "50.000", harvestSeason: "2025-Main",
      isLienActive: false, state: "INGESTED" as const, ownerId: producer2.id,
      estimatedValueUsd: "200000.00",
      moisturePct: "11.50", coffeeBeanSize: "AA" as const, coffeeCuppingScore: "8.20",
    },
    {
      ewrsReceiptId: "EWR-KSM-2025-005", wrscSignature: "WRSC-SIG-5c6d7e8f",
      warehouseCode: "KSM-WH-03", commodityType: "COFFEE" as const, batchType: "SEMI_FUNGIBLE" as const,
      grade: "AB", weightMt: "35.000", harvestSeason: "2025-Main",
      isLienActive: false, state: "MARKET_LISTED" as const, ownerId: producer2.id,
      estimatedValueUsd: "126000.00",
      moisturePct: "11.80", coffeeBeanSize: "AB" as const, coffeeCuppingScore: "7.80",
    },
    {
      ewrsReceiptId: "EWR-KSM-2025-013", wrscSignature: "WRSC-SIG-0i1j2k3l",
      warehouseCode: "KSM-WH-03", commodityType: "COFFEE" as const, batchType: "SEMI_FUNGIBLE" as const,
      grade: "C", weightMt: "25.000", harvestSeason: "2025-Main",
      isLienActive: true, lienHolderId: financier.id, state: "ENCUMBERED" as const, ownerId: producer1.id,
      estimatedValueUsd: "75000.00",
      moisturePct: "12.00", coffeeBeanSize: "C" as const, coffeeCuppingScore: "7.10",
    },
    {
      ewrsReceiptId: "EWR-ELD-2025-019", wrscSignature: "WRSC-SIG-M3N4O5P6",
      warehouseCode: "ELD-WH-06", commodityType: "COFFEE" as const, batchType: "SEMI_FUNGIBLE" as const,
      grade: "AA", weightMt: "40.000", harvestSeason: "2025-Main",
      isLienActive: false, state: "MARKET_LISTED" as const, ownerId: producer1.id,
      estimatedValueUsd: "168000.00",
      moisturePct: "11.40", coffeeBeanSize: "AA" as const, coffeeCuppingScore: "8.50",
    },

    // ── Tea (4 receipts) — NON_FUNGIBLE, unique invoice per factory run ───
    {
      ewrsReceiptId: "EWR-NKR-2025-006", wrscSignature: "WRSC-SIG-2g3h4i5j",
      warehouseCode: "NKR-WH-04", commodityType: "TEA" as const, batchType: "NON_FUNGIBLE" as const,
      grade: "BOP", weightMt: "75.000", harvestSeason: "2025-Q1",
      isLienActive: false, state: "MARKET_LISTED" as const, ownerId: producer1.id,
      estimatedValueUsd: "112500.00",
      teaProcessingType: "CTC" as const, teaLeafGrade: "BOP" as const, teaInvoiceSerial: "NKR-INV-2025-0601",
    },
    {
      ewrsReceiptId: "EWR-NKR-2025-007", wrscSignature: "WRSC-SIG-6k7l8m9n",
      warehouseCode: "NKR-WH-04", commodityType: "TEA" as const, batchType: "NON_FUNGIBLE" as const,
      grade: "PF", weightMt: "40.000", harvestSeason: "2025-Q1",
      isLienActive: false, state: "INGESTED" as const, ownerId: producer2.id,
      estimatedValueUsd: "56000.00",
      teaProcessingType: "ORTHODOX" as const, teaLeafGrade: "PF" as const, teaInvoiceSerial: "NKR-INV-2025-0702",
    },
    {
      ewrsReceiptId: "EWR-NKR-2025-014", wrscSignature: "WRSC-SIG-4m5n6o7p",
      warehouseCode: "NKR-WH-04", commodityType: "TEA" as const, batchType: "NON_FUNGIBLE" as const,
      grade: "BOPF", weightMt: "60.000", harvestSeason: "2025-Q2",
      isLienActive: true, lienHolderId: financier.id, state: "ENCUMBERED" as const, ownerId: producer2.id,
      estimatedValueUsd: "90000.00",
      teaProcessingType: "CTC" as const, teaLeafGrade: "BOPF" as const, teaInvoiceSerial: "NKR-INV-2025-1403",
    },
    {
      ewrsReceiptId: "EWR-NKR-2025-020", wrscSignature: "WRSC-SIG-Q7R8S9T0",
      warehouseCode: "NKR-WH-04", commodityType: "TEA" as const, batchType: "NON_FUNGIBLE" as const,
      grade: "D1", weightMt: "55.000", harvestSeason: "2025-Q2",
      isLienActive: false, state: "MARKET_LISTED" as const, ownerId: producer1.id,
      estimatedValueUsd: "79750.00",
      teaProcessingType: "CTC" as const, teaLeafGrade: "D1" as const, teaInvoiceSerial: "NKR-INV-2025-2004",
    },

    // ── Avocado (2 receipts) — TIME_DECAYING, EAS 19:2017, 30-day CA storage
    {
      ewrsReceiptId: "EWR-NAI-2025-008", wrscSignature: "WRSC-SIG-0o1p2q3r",
      warehouseCode: "NAI-WH-05", commodityType: "AVOCADO" as const, batchType: "TIME_DECAYING" as const,
      grade: "Export A", weightMt: "20.000", harvestSeason: "2025-Harvest",
      isLienActive: false, state: "MARKET_LISTED" as const, ownerId: producer1.id,
      estimatedValueUsd: "28000.00", expiryAt: avocadoExpiry,
      avocadoVariety: "HASS" as const, avocadoSizingCode: 18, avocadoColdChainCompliant: true,
      avocadoDegradationCoefficient: "1.0000",
    },
    {
      ewrsReceiptId: "EWR-NAI-2025-009", wrscSignature: "WRSC-SIG-4s5t6u7v",
      warehouseCode: "NAI-WH-05", commodityType: "AVOCADO" as const, batchType: "TIME_DECAYING" as const,
      grade: "Export B", weightMt: "15.000", harvestSeason: "2025-Harvest",
      isLienActive: false, state: "INGESTED" as const, ownerId: producer2.id,
      estimatedValueUsd: "18750.00", expiryAt: new Date(now.getTime() + 15 * 24 * 60 * 60 * 1000),
      avocadoVariety: "FUERTE" as const, avocadoSizingCode: 22, avocadoColdChainCompliant: true,
      avocadoDegradationCoefficient: "0.5000",
    },
  ];

...
const BOND_COLORS: Record<string, string> = {
  PENDING_BOND: "text-slate-600 bg-slate-50 border-slate-200",
  ACTIVE: "text-green-700 bg-green-50 border-green-200",
  FORFEITED: "text-red-700 bg-red-50 border-red-200",
  RELEASED: "text-gray-500 bg-gray-50 border-gray-200",
  LOCKED: "text-slate-600 bg-slate-50 border-slate-200",
};
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <div className="p-3 rounded-lg bg-slate-50 border border-slate-200 text-center">
                <p className="text-xs text-slate-700 mb-1">Performance Bond (15%)</p>
                <p className="text-xl font-bold text-slate-800">${parseFloat(String(contract.performanceBondUsd)).toFixed(0)}</p>
              </div>
              <div className="p-3 rounded-lg bg-muted/40 text-center">

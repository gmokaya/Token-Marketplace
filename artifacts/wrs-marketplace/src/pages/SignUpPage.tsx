      ...
      <div className="relative z-10 w-full max-w-[420px] mr-8 md:mr-16 xl:mr-24">
        <div className="bg-white/10 backdrop-blur-2xl border border-white/25 shadow-2xl p-10 overflow-y-auto max-h-[calc(100vh-4rem)]">
          <div className="mb-7">
            ...
            <p className="text-sm text-white/65 mt-1.5">Join the Grain Marketplace today.</p>
          </div>
          ...
          <p className="mt-5 text-center text-sm text-white/60">
            ...
            <a href={`${bp}/sign-in`} className="font-semibold text-yellow-300 hover:text-yellow-200 transition-colors">
              Sign in
            </a>
          </p>
        </div>

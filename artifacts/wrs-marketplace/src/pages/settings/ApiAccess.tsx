...
function scopeBadge(scope: string) {
  const colors: Record<string, string> = {
    "ewr:push":    "bg-slate-800/40 text-slate-300 border-slate-700/40",
    "wrsc:intake": "bg-blue-900/20  text-blue-300  border-blue-800/40",
  };
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4">
          <div>
            ...
            <Input
              id="key-name"
              placeholder="e.g. Nakuru Grain Silo Portal"
              value={name}
...
function SetupGuide() {
  ...
  const ewrPayload = `{
  "commodityType": "MAIZE",    // COFFEE | TEA | MAIZE | RICE | AVOCADO
  "warehouseCode": "NKR-001",  // Your WRSC-registered warehouse code
  "quantityMt": 10.0,
  "grade": "AA",               // AA | AB | PB | C | E | TT | T
  "moisture": 13.0,            // ≤ 13.5 % for MAIZE
  "foreignMatter": 0.5,

...
export const marketplaceOnboardingProfilesTable = pgTable("marketplace_onboarding_profiles", {
  ...
  region: text("region"),
  city: text("city"),
  coffeeOriginCountry: text("coffee_origin_country"),
  coffeeOriginRegion: text("coffee_origin_region"),
  coffeeVariety: text("coffee_variety"),
  coffeeProcessingType: text("coffee_processing_type"),
  teaOriginCountry: text("tea_origin_country"),
  teaOriginRegion: text("tea_origin_region"),
  teaVariety: text("tea_variety"),
  teaType: text("tea_type"),
  teaProcessingMethod: text("tea_processing_method"),
  teaGrade: text("tea_grade"),
